      ...
      <div className="text-center">
        {uploadProgress.isUploading && (
          <>
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Uploading Video...</h3>
        ...
        {uploadProgress.error && (
          <>
            ...
            <h3 className="text-lg font-semibold text-red-900 dark:text-red-400 mb-2">Upload Failed</h3>
        ...
        {shareableUrl && !uploadProgress.isUploading && (
          <>
            ...
            <div className="bg-gray-50 dark:bg-dark-800 rounded-lg p-4 mb-4 transition-colors duration-300">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  value={shareableUrl}
                  readOnly
                  className="flex-1 px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg text-sm bg-white dark:bg-dark-700 text-gray-900 dark:text-white transition-colors duration-300"
                />
                <button
                  onClick={() => copyToClipboard(shareableUrl)}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded-lg transition-all duration-300 hover:scale-105"
                >
                  Copy
                </button>
              </div>
            ...
            <a
              ...
              className="inline-block bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 hover:scale-105 shadow-lg"
            >
              View Video
            </a>
          </>
