    ...
    <div className="min-h-screen bg-white dark:bg-dark-950 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900 dark:text-white">Rekordr</span>
            </div>
      ...
      <section className="bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-dark-900 dark:via-dark-950 dark:to-purple-950/20 py-20 transition-colors duration-300">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight animate-fade-in">
              Record. Upload. Share.
              <span className="text-blue-600 block">Instantly.</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed animate-slide-up">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-50 dark:bg-dark-900 rounded-xl p-8 hover:bg-gray-100 dark:hover:bg-dark-800 transition-all duration-300 hover:scale-105 hover:shadow-lg">
      ...
      <section className="py-20 bg-white dark:bg-dark-950 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-950/30 dark:to-purple-950/30 rounded-2xl p-8 transition-colors duration-300">
              <div className="bg-white dark:bg-dark-900 rounded-lg p-6 shadow-lg transition-colors duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-white dark:bg-dark-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Browser Native</h3>
            ...
            <div className="text-center">
              <div className="bg-white dark:bg-dark-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">Firebase integration for reliable uploads</p>
              </div>
            </div>
            <div className="text-center">
              <div className="bg-white dark:bg-dark-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Real-time Preview</h3>
            ...
            <div className="text-center">
              <div className="bg-white dark:bg-dark-800 rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-3" />
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Universal Playback</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700 transition-colors duration-300">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <Link
              to="/record"
              className="bg-white hover:bg-gray-100 text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 inline-flex items-center space-x-2 hover:scale-105 shadow-lg"
            >
              <span>Start Recording Now</span>
              <ArrowRight className="w-5 h-5" />
            </Link>
      ...
      <footer className="bg-gray-900 dark:bg-dark-950 text-white py-12 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold text-white">Rekordr</span>
              </div>
          ...
          <div className="border-t border-gray-800 dark:border-dark-700 mt-8 pt-8 text-center text-gray-400 dark:text-gray-300">
